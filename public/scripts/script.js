...
// is_commands
function is_ping_command(msg) {
  return msg.command === COMMANDS.PING;
}
function is_info_command(msg) {
  return msg.command === COMMANDS.INFO;
}

// status off command
function is_failed_command(msg) {
  return msg.state === STATUS.FAIL;
}

function is_succsess_command(msg) {
  return msg.state === STATUS.OK;
}
